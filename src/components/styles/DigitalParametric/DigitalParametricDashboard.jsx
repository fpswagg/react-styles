...
import './DigitalParametric.css';

const DigitalParametricDashboard = () => {
  ...
  const projects = [
    {
      ...
      description: 'Projet utilisant des algorithmes et modélisation paramétrique avancée',
      year: 2024,
      type: 'Paramétrique',
      location: 'Casablanca'
    },
    {
      ...
      description: 'Exploration de formes générées par algorithmes computationnels',
      year: 2023,
      type: 'Algorithmique',
      location: 'Rabat'
    },
    {
      ...
      description: 'Projet de design numérique avec technologies BIM et CAO',
      year: 2024,
      type: 'Numérique',
      location: 'Fès'
    }
  ...
  const news = [
    {
      id: '1',
      title: 'Conférence Design Paramétrique 2024',
      excerpt: 'Découvrez les dernières avancées en design paramétrique et computationnel',
      publishedAt: '2024-12-01',
      category: 'Événements'
    },
    {
      id: '2',
      title: 'Prix Innovation Numérique 2024',
      excerpt: 'L\'ESSACA reçoit le prix d\'excellence pour l\'innovation numérique',
  ...
  return (
    <div className="digital-parametric-container">
      <motion.header
        className="page-header bg-interface"
      ...
      >
        <div className="header-content flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h1 className="text-display text-neon">
            ...
            {['home', 'about', 'programs', 'projects', 'news', 'contact'].map((item) => (
              <button
                ...
                className={`text-xs sm:text-sm text-main-60 hover:text-main transition-colors px-2 sm:px-3 py-1.5 sm:py-2 rounded-full border border-main-20 hover:border-main-40 ${
                  activeSection === item ? 'bg-page text-neon border-neon' : ''
                }`}
          ...
          >
            <div className="container-main mb-8 hero-section">
              ...
              <div className="hero-content-wrapper">
                ...
                >
                  Architecture générée par algorithmes et computation
                </motion.p>
                <motion.div
                ...
                >
                  <button className="btn-cta">Explorer l'algorithme</button>
                  <button className="btn-secondary">Nos projets</button>
                </motion.div>
              </div>
              <div className="band-neon"></div>
            </div>
            ...
            >
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="text-display text-neon mb-2" style={{ fontSize: '2.5rem' }}>
                      {stat.value}
                    </div>
                    <div className="text-main-70 text-sm sm:text-base mb-1">{stat.label}</div>
                    <div className="text-data text-xs sm:text-sm font-medium">{stat.trend}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
                  ...
                  >
                    <div className="card-header">
                      ...
                      <div className="flex gap-2 mb-3">
                        <span className="text-xs text-neon font-medium">{program.level}</span>
      ...
      <footer className="bg-main text-interface py-8 mt-12">
        <div className="header-content">
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
            <div>
              <h3 className="text-display text-interface mb-2" style={{ fontSize: '1.5rem' }}>
                ESSACA
              </h3>
          ...
          <div className="border-t border-interface/20 mt-8 pt-8 text-center text-sm opacity-60">
...
export default DigitalParametricDashboard;
