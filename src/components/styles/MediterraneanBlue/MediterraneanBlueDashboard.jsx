...
import './MediterraneanBlue.css';

const MediterraneanBlueDashboard = () => {
  ...
  const projects = [
    {
      ...
      description: 'Projet d\'architecture inspiré de la Méditerranée et du littoral marocain',
      year: 2024,
      type: 'Côtier',
      location: 'Tanger'
    },
    {
      id: '2',
      title: 'Design Maritime',
      description: 'Architecture harmonieuse avec l\'environnement méditerranéen',
      year: 2023,
      type: 'Maritime',
      location: 'Al Hoceima'
    },
    {
      ...
      description: 'Projet résidentiel inspiré de l\'architecture méditerranéenne traditionnelle',
      year: 2024,
      type: 'Résidentiel',
      location: 'Tétouan'
    }
  ...
  const news = [
    {
      id: '1',
      title: 'Exposition Architecture Méditerranéenne',
      excerpt: 'Découvrez notre exposition sur l\'architecture méditerranéenne',
      publishedAt: '2024-12-01',
      category: 'Événements'
    },
    {
      id: '2',
      title: 'Prix Architecture Côtière 2024',
      excerpt: 'L\'ESSACA reçoit le prix d\'excellence pour l\'architecture côtière',
  ...
  return (
    <div className="mediterranean-blue-container">
      <motion.header
      ...
      >
        <div className="header-content flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h1 className="text-display text-ocean">
            ...
            {['home', 'about', 'programs', 'projects', 'news', 'contact'].map((item) => (
              <button
                ...
                className={`text-xs sm:text-sm text-main-60 hover:text-main transition-colors px-2 sm:px-3 py-1.5 sm:py-2 rounded-full border border-main-20 hover:border-main-40 ${
                  activeSection === item ? 'bg-page text-ocean border-ocean' : ''
                }`}
            ...
            >
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="text-display text-ocean mb-2" style={{ fontSize: '2.5rem' }}>
                      {stat.value}
                    </div>
                    <div className="text-main-70 text-sm sm:text-base mb-1">{stat.label}</div>
                    <div className="text-sage text-xs sm:text-sm font-medium">{stat.trend}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
                  ...
                  >
                    ...
                    <div className="card-content">
                      ...
                      <div className="flex gap-2 mb-4">
                        <span className="text-xs text-ocean font-medium">{project.type}</span>
                  ...
                  >
                    <div className="card-header">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-xs text-ocean font-medium">{item.category}</span>
                  ...
                  >
                    <div className="card-header">
                      ...
                      <div className="flex gap-2 mb-3">
                        <span className="text-xs text-ocean font-medium">{program.level}</span>
...
export default MediterraneanBlueDashboard;
