...
const AcademicExcellenceDashboard = () => {
  ...
  const projects = [
    {
      id: '1',
      title: 'Recherche Architecturale',
      description: 'Projet de recherche académique sur l\'architecture durable',
      year: 2024,
      type: 'Recherche',
      location: 'Casablanca'
    },
    {
      ...
      description: 'Développement de nouveaux programmes d\'enseignement',
      year: 2023,
      type: 'Éducation',
      location: 'Rabat'
    },
    {
      ...
      description: 'Publication sur les tendances architecturales contemporaines',
      year: 2024,
      type: 'Académique',
      location: 'Fès'
    }
  ...
  const news = [
    {
      id: '1',
      title: 'Conférence Académique 2024',
      excerpt: 'Grande conférence sur l\'excellence académique en architecture',
      publishedAt: '2024-12-01',
      category: 'Événements'
    },
    {
      id: '2',
      title: 'Prix Excellence Académique',
      excerpt: 'L\'ESSACA reçoit le prix d\'excellence académique 2024',
  ...
  return (
    <div className="academic-excellence-container">
      <motion.header
            ...
            {['home', 'about', 'programs', 'projects', 'news', 'contact'].map((item) => (
              <button
                ...
                className={`text-xs sm:text-sm text-main-60 hover:text-main transition-colors px-2 sm:px-3 py-1.5 sm:py-2 rounded-full border border-main-20 hover:border-main-40 ${
                  activeSection === item ? 'bg-page text-navy border-navy' : ''
                }`}
            ...
            >
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="text-display text-navy mb-2" style={{ fontSize: '2.5rem' }}>
                      {stat.value}
                    </div>
                    <div className="text-main-70 text-sm sm:text-base mb-1">{stat.label}</div>
                    <div className="text-forest text-xs sm:text-sm font-medium">{stat.trend}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
                  ...
                  >
                    ...
                    <div className="card-content">
                      ...
                      <div className="flex gap-2 mb-4">
                        <span className="text-xs text-navy font-medium">{project.type}</span>
                  ...
                  >
                    <div className="card-header">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-xs text-navy font-medium">{item.category}</span>
                  ...
                  >
                    <div className="card-header">
                      ...
                      <div className="flex gap-2 mb-3">
                        <span className="text-xs text-navy font-medium">{program.level}</span>
...
export default AcademicExcellenceDashboard;
