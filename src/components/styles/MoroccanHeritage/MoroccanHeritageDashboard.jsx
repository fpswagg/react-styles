...
import './MoroccanHeritage.css';

const MoroccanHeritageDashboard = () => {
  ...
  const projects = [
    {
      ...
      description: 'Restoration et préservation du patrimoine architectural marocain traditionnel',
      year: 2024,
      type: 'Patrimoine',
      location: 'Fès'
    },
    {
      id: '2',
      title: 'Zellij Moderne',
      description: 'Intégration des motifs zellij dans l\'architecture contemporaine',
      year: 2023,
      type: 'Design',
      location: 'Marrakech'
    },
    {
      ...
      description: 'Projet inspiré des principes de l\'architecture islamique classique',
      year: 2024,
      type: 'Tradition',
      location: 'Rabat'
    }
  ...
  const news = [
    {
      id: '1',
      title: 'Exposition Zellij et Géométrie',
      excerpt: 'Découvrez notre exposition sur les motifs géométriques de l\'architecture marocaine',
      publishedAt: '2024-12-01',
      category: 'Événements'
    },
    {
      id: '2',
      title: 'Prix du Patrimoine 2024',
      excerpt: 'L\'ESSACA reçoit le prix d\'excellence pour la préservation du patrimoine',
  ...
  return (
    <div className="moroccan-heritage-container">
      <motion.header
        className="page-header bg-cream"
      ...
      >
        <div className="header-content flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h1 className="text-display text-terracotta">
            ...
            {['home', 'about', 'programs', 'projects', 'news', 'contact'].map((item) => (
              <button
                ...
                className={`text-xs sm:text-sm text-main-60 hover:text-main transition-colors px-2 sm:px-3 py-1.5 sm:py-2 border border-main-20 hover:border-main-40 ${
                  activeSection === item ? 'bg-page text-terracotta border-terracotta' : ''
                }`}
        ...
        {activeSection === 'home' && (
          ...
          >
            <div className="container-main mb-8 hero-section">
              ...
              <div className="band-terracotta"></div>
            </div>
            ...
            >
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="text-display text-terracotta mb-2" style={{ fontSize: '2.5rem' }}>
                      {stat.value}
                    </div>
                    <div className="text-main-70 text-sm sm:text-base mb-1">{stat.label}</div>
                    <div className="text-gold text-xs sm:text-sm font-medium">{stat.trend}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
                  ...
                  >
                    ...
                    <div className="card-content">
                      ...
                      <div className="flex gap-2 mb-4">
                        <span className="text-xs text-terracotta font-medium">{project.type}</span>
                  ...
                  >
                    <div className="card-header">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-xs text-terracotta font-medium">{item.category}</span>
                  ...
                  >
                    <div className="card-header">
                      ...
                      <div className="flex gap-2 mb-3">
                        <span className="text-xs text-terracotta font-medium">{program.level}</span>
      ...
      <footer className="bg-main text-cream py-8 mt-12">
        <div className="header-content">
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
            <div>
              <h3 className="text-display text-cream mb-2" style={{ fontSize: '1.5rem' }}>
                ESSACA
              </h3>
          ...
          <div className="border-t border-cream/20 mt-8 pt-8 text-center text-sm opacity-60">
...
export default MoroccanHeritageDashboard;
