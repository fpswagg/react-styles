...
const InnovativeDesignDashboard = () => {
  ...
  const projects = [
    {
      ...
      description: 'Projet expérimental avec technologies de pointe et design futuriste',
      year: 2024,
      type: 'Innovation',
      location: 'Casablanca'
    },
    {
      ...
      description: 'Intégration de technologies numériques dans l\'architecture',
      year: 2023,
      type: 'Technologie',
      location: 'Rabat'
    },
    {
      id: '3',
      title: 'Design Expérimental',
      description: 'Exploration de nouvelles formes et matériaux innovants',
      year: 2024,
      type: 'Recherche',
      location: 'Fès'
    }
  ...
  const news = [
    {
      ...
      excerpt: 'Découvrez les dernières innovations en architecture et design',
      publishedAt: '2024-12-01',
      category: 'Événements'
    },
    {
      id: '2',
      title: 'Prix Innovation Design 2024',
      excerpt: 'L\'ESSACA reçoit le prix d\'innovation en design architectural',
  ...
  return (
    <div className="innovative-design-container">
      <motion.header
      ...
      >
        <div className="header-content flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h1 className="text-display text-electric">
            ...
            {['home', 'about', 'programs', 'projects', 'news', 'contact'].map((item) => (
              <button
                ...
                className={`text-xs sm:text-sm text-main-60 hover:text-main transition-colors px-2 sm:px-3 py-1.5 sm:py-2 rounded-full border border-main-20 hover:border-main-40 ${
                  activeSection === item ? 'bg-page text-electric border-electric' : ''
                }`}
        ...
        {activeSection === 'home' && (
          ...
          >
            <div className="container-main mb-8 hero-section">
              ...
              <div className="band-electric"></div>
            </div>
            ...
            >
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="text-display text-electric mb-2" style={{ fontSize: '2.5rem' }}>
                      {stat.value}
                    </div>
                  ...
                  >
                    ...
                    <div className="card-content">
                      ...
                      <div className="flex gap-2 mb-4">
                        <span className="text-xs text-electric font-medium">{project.type}</span>
                  ...
                  >
                    <div className="card-header">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-xs text-electric font-medium">{item.category}</span>
                  ...
                  >
                    <div className="card-header">
                      ...
                      <div className="flex gap-2 mb-3">
                        <span className="text-xs text-electric font-medium">{program.level}</span>
...
export default InnovativeDesignDashboard;
