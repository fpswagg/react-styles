...
const BasicStyleDashboard = () => {
  ...
  const projects = [
    {
      id: '1',
      title: 'Restoration du Patrimoine',
      description: 'Projet de restauration d\'un bâtiment historique marocain',
      year: 2024,
      type: 'Restoration',
      location: 'Fès'
    },
    {
      ...
      description: 'Nouveau campus avec architecture contemporaine',
      year: 2023,
      type: 'Construction',
      location: 'Casablanca'
    },
    {
      ...
      description: 'Projet d\'habitat écologique et durable',
      year: 2024,
      type: 'Développement',
      location: 'Rabat'
    }
  ...
  const news = [
    {
      id: '1',
      title: 'Nouvelle Exposition Architecture',
      excerpt: 'Découvrez notre nouvelle exposition sur l\'architecture marocaine moderne',
    ...
    },
    {
      ...
      excerpt: 'L\'ESSACA reçoit le prix d\'excellence en architecture',
  ...
  return (
    <div className="basic-style-container">
      {/* Header */}
      <motion.header
        className="page-header bg-cta border-main-10"
      ...
      >
        <div className="header-content flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h1 className="text-display text-burgundy">
            ...
            {['home', 'about', 'programs', 'projects', 'news', 'contact'].map((item) => (
              <button
                ...
                className={`text-xs sm:text-sm text-main-60 hover:text-main transition-colors px-2 sm:px-3 py-1.5 sm:py-2 rounded-full border border-main-20 hover:border-main-40 ${
                  activeSection === item ? 'bg-page text-burgundy border-burgundy' : ''
                }`}
            ...
            >
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="text-display text-burgundy mb-2" style={{ fontSize: '2.5rem' }}>
                      {stat.value}
                    </div>
                    <div className="text-main-70 text-sm sm:text-base mb-1">{stat.label}</div>
                    <div className="text-burgundy text-xs sm:text-sm font-medium">{stat.trend}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
                  ...
                  >
                    ...
                    <div className="card-content">
                      ...
                      <div className="flex gap-2 mb-4">
                        <span className="text-xs text-burgundy font-medium">{project.type}</span>
                  ...
                  >
                    <div className="card-header">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-xs text-burgundy font-medium">{item.category}</span>
                  ...
                  >
                    <div className="card-header">
                      ...
                      <div className="flex gap-2 mb-3">
                        <span className="text-xs text-burgundy font-medium">{program.level}</span>
      ...
      {/* Footer */}
      <footer className="bg-main text-cta py-8 mt-12">
        <div className="header-content">
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
            <div>
              <h3 className="text-display text-cta mb-2" style={{ fontSize: '1.5rem' }}>
                ESSACA
              </h3>
          ...
          <div className="border-t border-cta/20 mt-8 pt-8 text-center text-sm opacity-60">
...
export default BasicStyleDashboard;
