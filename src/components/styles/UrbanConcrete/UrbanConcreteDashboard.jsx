...
import './UrbanConcrete.css';

const UrbanConcreteDashboard = () => {
  ...
  const projects = [
    {
      id: '1',
      title: 'Structure Brutale',
      description: 'Architecture audacieuse avec formes géométriques puissantes et contrastes marqués',
      year: 2024,
      type: 'Structure',
      location: 'Casablanca'
    },
    {
      ...
      description: 'Approche directe avec volumes imposants et lignes nettes',
      year: 2023,
      type: 'Modulaire',
      location: 'Rabat'
    },
    {
      id: '3',
      title: 'Architecture Raw',
      description: 'Esthétique brute avec matériaux bruts et finitions expressives',
      year: 2024,
      type: 'Système',
      location: 'Fès'
    }
  ...
  const news = [
    {
      id: '1',
      title: 'Conférence Brutalisme',
      excerpt: 'Exploration des principes du brutalisme architectural et design audacieux',
      publishedAt: '2024-12-01',
      category: 'Événements'
    },
    {
      id: '2',
      title: 'Prix Architecture Bold 2024',
      excerpt: 'Reconnaissance pour nos projets aux formes puissantes et design impactant',
  ...
  return (
    <div className="urban-concrete-container">
      <motion.header
        className="page-header bg-card"
      ...
      >
        <div className="header-content flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h1 className="text-display text-steel">
          ...
          <nav className="flex items-center gap-2 sm:gap-3">
            {['home', 'about', 'programs', 'projects', 'news', 'contact'].map((item) => (
              <button
                key={item}
                className={`text-xs sm:text-sm transition-colors px-2 sm:px-3 py-1.5 sm:py-2 border-3 border-steel font-bold uppercase ${
                  activeSection === item ? 'bg-steel text-card' : 'bg-card text-steel'
                }`}
          ...
          >
            <div className="container-main mb-8 hero-section">
              <div className="hero-image-container">
                <img
                  src="https://images.unsplash.com/photo-1487958449943-2429e8d86225?w=1200&h=600&fit=crop"
                  alt="Architecture urbaine brutale"
                  loading="eager"
                />
              </div>
              <div className="hero-content-wrapper">
                ...
                <motion.p
                  className="text-main-70 text-base sm:text-lg max-w-2xl mx-auto mb-6"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="text-display text-steel mb-2" style={{ fontSize: '2.5rem' }}>
                      {stat.value}
                    </div>
                    <div className="text-main-70 text-sm sm:text-base mb-1">{stat.label}</div>
                    <div className="text-steel text-xs sm:text-sm font-medium">{stat.trend}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
                  ...
                  >
                    ...
                    <div className="card-content">
                      ...
                      <div className="flex gap-2 mb-4">
                        <span className="text-xs text-steel font-medium">{project.type}</span>
                  ...
                  >
                    <div className="card-header">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-xs text-steel font-medium">{item.category}</span>
                  ...
                  >
                    <div className="card-header">
                      ...
                      <div className="flex gap-2 mb-3">
                        <span className="text-xs text-steel font-medium">{program.level}</span>
      ...
      <footer className="bg-main text-card py-8 mt-12">
        <div className="header-content">
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
            <div>
              <h3 className="text-display text-card mb-2" style={{ fontSize: '1.5rem' }}>
                ESSACA
              </h3>
          ...
          <div className="border-t border-card/20 mt-8 pt-8 text-center text-sm opacity-60">
...
export default UrbanConcreteDashboard;
