...
import './SustainableEarth.css';

const SustainableEarthDashboard = () => {
  ...
  const projects = [
    {
      ...
      description: 'Projet écologique utilisant des matériaux naturels et durables',
      year: 2024,
      type: 'Durable',
      location: 'Casablanca'
    },
    {
      id: '2',
      title: 'Construction Naturelle',
      description: 'Utilisation de matériaux locaux et respectueux de l\'environnement',
      year: 2023,
      type: 'Écologique',
      location: 'Rabat'
    },
    {
      id: '3',
      title: 'Éco-Architecture',
      description: 'Design intégrant les principes de développement durable',
      year: 2024,
      type: 'Durable',
      location: 'Fès'
    }
  ...
  const news = [
    {
      ...
      excerpt: 'Découvrez les dernières innovations en architecture durable',
      publishedAt: '2024-12-01',
      category: 'Événements'
    },
    {
      id: '2',
      title: 'Prix Architecture Verte 2024',
      excerpt: 'L\'ESSACA reçoit le prix d\'excellence pour l\'architecture durable',
  ...
  return (
    <div className="sustainable-earth-container">
      <motion.header
        className="page-header bg-linen"
      ...
      >
        <div className="header-content flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h1 className="text-display text-bamboo">
          ...
          <nav className="flex items-center gap-2 sm:gap-3">
            {['home', 'about', 'programs', 'projects', 'news', 'contact'].map((item) => (
              <button
                key={item}
                className={`text-xs sm:text-sm text-main-60 hover:text-main transition-colors px-2 sm:px-3 py-1.5 sm:py-2 rounded-full border border-main-20 hover:border-main-40 ${
                  activeSection === item ? 'bg-page text-bamboo border-bamboo' : ''
                }`}
          ...
          >
            <div className="container-main mb-8 hero-section">
              ...
              <div className="hero-content-wrapper">
                ...
                >
                  <button className="btn-cta">Découvrir la durabilité</button>
                  <button className="btn-secondary">Nos projets verts</button>
                </motion.div>
              </div>
              <div className="band-bamboo"></div>
            </div>
            ...
            >
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className="text-display text-bamboo mb-2" style={{ fontSize: '2.5rem' }}>
                      {stat.value}
                    </div>
                    <div className="text-main-70 text-sm sm:text-base mb-1">{stat.label}</div>
                    <div className="text-clay text-xs sm:text-sm font-medium">{stat.trend}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
                  ...
                  >
                    ...
                    <div className="card-content">
                      ...
                      <div className="flex gap-2 mb-4">
                        <span className="text-xs text-bamboo font-medium">{project.type}</span>
                  ...
                  >
                    <div className="card-header">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-xs text-bamboo font-medium">{item.category}</span>
                ...
                <div className="card">
                  ...
                  <ul className="space-y-3">
                    <li className="text-main-70 flex items-start">
                      <span className="text-bamboo mr-2">•</span>
                  ...
                  >
                    <div className="card-header">
                      ...
                      <div className="flex gap-2 mb-3">
                        <span className="text-xs text-bamboo font-medium">{program.level}</span>
      ...
      <footer className="bg-main text-linen py-8 mt-12">
        <div className="header-content">
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
            <div>
              <h3 className="text-display text-linen mb-2" style={{ fontSize: '1.5rem' }}>
                ESSACA
              </h3>
          ...
          <div className="border-t border-linen/20 mt-8 pt-8 text-center text-sm opacity-60">
...
export default SustainableEarthDashboard;
